...
class Search extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {searchText: this.props.text};
    ...
    render() {
        return (
            <div className="search-container">
                <div className="button-white search-field">
                    <input type="text" placeholder="Search for breeds by name" className="search-input" onChange={this.inputTextChange} value={this.state.searchText}/>
                    <Link to={'../search/' + this.state.searchText}><img src={glass} alt="Search" className="button-white button-small btn-glass" /></Link>
                </div>

                <Link to="../likes" className="button-white button-big">
                ...
                <Link to="../favourites" className="button-white button-big">
                ...
                <Link to="../dislikes" className="button-white button-big">
                    <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
